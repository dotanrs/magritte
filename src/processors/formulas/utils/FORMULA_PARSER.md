...
into a `Formula`: an owned tree of `FormulaNode` objects. Processor selection
and image evaluation happen elsewhere.

The implementation is in
[`formula_parse.cpp`](formula_parse.cpp), and the resulting types are declared
in
[`formula_parse.h`](../../../../include/magritte/processors/utils/formula_parse.h).
...
in a processor-specific container:
